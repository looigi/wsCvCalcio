...
<System.Web.Services.WebService(Namespace:="http://cvcalcio_evconv.org/")>
<System.Web.Services.WebServiceBinding(ConformsTo:=WsiProfiles.BasicProfile1_1)>
<ToolboxItem(False)>
Public Class wsEventiConvocazioni
	...
	Public Function RitornaEventi(Squadra As String) As String
		...
		Else
			...
			Else
				...
				Sql = "SELECT * From EventiConvocazioni"
				Rec = Conn.LeggeQuery(Server.MapPath("."),   Sql, Connessione)
				If TypeOf (Rec) Is String Then
					Ritorno = Rec
				Else
		...
		Else
			...
			Else
				...
				If ritEliminazione = "*" Then
					Sql = "Delete From EventiConvocazioni Where idEvento = " & idEvento
					Ritorno = Conn.EsegueSql(Server.MapPath("."), Sql, Connessione)
				Else
	...
	Public Function ModificaEvento(Squadra As String, idEvento As String, idTipologia As String, Titolo As String, Inizio As String, Fine As String, TuttiIGiorni As String,
		...
		Else
			...
			Else
				...
				Sql = "Update EventiConvocazioni Set " &
