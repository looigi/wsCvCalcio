...
Public Class wsDirigenti
    ...
    <WebMethod()>
    Public Function SalvaDirigente(idAnno As String, idCategoria As String, idDirigente As String, Cognome As String, Nome As String, EMail As String, Telefono As String) As String
    ...
    <WebMethod()>
    Public Function RitornaDirigentiCategoria(ByVal idAnno As String, idCategoria As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
    ...
    <WebMethod()>
    Public Function EliminaDirigente(ByVal idAnno As String, idDirigente As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
