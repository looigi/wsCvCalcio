...
Public Class wsAllenamenti
    ...
    <WebMethod()>
    Public Function SalvaAllenamenti(idAnno As String, idCategoria As String, Data As String, Ora As String, Giocatori As String) As String
    ...
    <WebMethod()>
    Public Function RitornaAllenamentiCategoria(ByVal idAnno As String, idCategoria As String, Data As String, Ora As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
