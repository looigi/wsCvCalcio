...
Public Class wsCategorie
    ...
    <WebMethod()>
    Public Function RitornaCategorie(ByVal idAnno As String, idUtente As String) As String
    ...
    <WebMethod()>
    Public Function EliminaCategoria(ByVal idAnno As String, idCategoria As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
