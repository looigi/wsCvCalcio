...
Public Class wsGiocatori
    ...
    <WebMethod()>
    Public Function RitornaGiocatoriCategoria(ByVal idAnno As String, ByVal idCategoria As String) As String
    ...
    <WebMethod()>
    Public Function SalvaGiocatore(idAnno As String, idCategoria As String, idGiocatore As String, idRuolo As String, Cognome As String, Nome As String, EMail As String, Telefono As String,
    ...
    <WebMethod()>
    Public Function EliminaGiocatore(ByVal idAnno As String, idGiocatore As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
