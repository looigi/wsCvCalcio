...
Public Class wsAvversari
    ...
    <WebMethod()>
    Public Function RitornaAvversari(ByVal idAnno As String, Ricerca As String) As String
    ...
    <WebMethod()>
    Public Function SalvaAvversario(idAnno As String, idAvversario As String, idCampo As String, Avversario As String, Campo As String, Indirizzo As String, Coords As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
    ...
    <WebMethod()>
    Public Function EliminaAvversario(ByVal idAnno As String, idAvversario As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
    ...
    <WebMethod()>
    Public Function RitornaStatisticheAvversario(ByVal idAnno As String, idAvversario As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
