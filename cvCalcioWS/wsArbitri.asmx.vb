...
Public Class wsArbitri
    ...
    <WebMethod()>
    Public Function SalvaArbitro(idAnno As String, idCategoria As String, idArbitro As String, Cognome As String, Nome As String, EMail As String, Telefono As String) As String
    ...
    <WebMethod()>
    Public Function RitornaArbitri(ByVal idAnno As String, idCategoria As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
    ...
    <WebMethod()>
    Public Function EliminaArbitro(ByVal idAnno As String, idArbitro As String) As String
        Dim Ritorno As String = ""
        Dim Connessione As String = LeggeImpostazioniDiBase(Server.MapPath("."))
